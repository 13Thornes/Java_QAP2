...
public class CreditCardDemo {
    ...
    CreditCard visa = new CreditCard(owner, LIMIT); System.out.println(visa.getPersonals()); 
    ...
    System.out.println("Balance : " + visa.getBalance()); 
    System.out.println("Attempt to charge " + FOURTH_AMOUNT); visa.charge(FOURTH_AMOUNT); System.out.println("Balance : " + visa.getBalance());
